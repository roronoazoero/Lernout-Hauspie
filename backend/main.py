...
print(f"DEBUG - LANGFLOW_URL: {os.getenv('LANGFLOW_URL', 'NOT_SET')}")
print(f"DEBUG - LANGFLOW_API_KEY: {'SET' if os.getenv('LANGFLOW_API_KEY') else 'NOT_SET'}")
print(f"DEBUG - LANGFLOW_FLOW_ID: {os.getenv('LANGFLOW_FLOW_ID', 'NOT_SET')}")
